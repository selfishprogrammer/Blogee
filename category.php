...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-dark" style="height: 700px;">

        <?php
$category_slno=$_GET['category_slno'];
$sql="SELECT * FROM `category` where `category_slno`='$category_slno'";
$result=mysqli_query($conn,$sql);
while($row=mysqli_fetch_assoc($result)){

    echo '<h1 class="display-4 my-4 text-center" style="color:honeydew;" id="title">'.$row['blog_category'].'</h1>


    <div class="d-flex justify-content-center">
            <img src="img/'.$row['blog_emoji'].'" alt="" class="mb-3 my-4" width="300px" height="300px">
            </div>
    <h6 id="title2" class="text-center my-4" style="color:honeydew;">'.$row['blog_category_desp'].'</h6>
...
<b><h3 style="color:red;" class="text-center">'.$row['blog_category'].'</h3></b>
</div>';
...
$sql1="SELECT * FROM `blog` where `blog_category_no` = '$category_slno'";
...
$post_id=$row1['blog_slno_1'];
                        ...
                        ?>
                            <div class="d-flex justify-content-between">
                                ...
                                <button id="" class="btn btn-danger my-4 mx-1" style="width: 8rem;">Dislike &nbsp;
                                    (0)</button>
                            </div>

                            <div class="card-header" style="background-color: gray; height:200px; overflow-y:auto;"
                                id="panel">
                                <form action="comments_cat.php?post_id=<?php echo $post_id ?>" method="post">
                                    <div class="form-group">

                                        <textarea name="comment" placeholder="Comment Your Thoughts"
                                            class="form-control my-4"></textarea>
                                        <input type="hidden" name="hidden" value="<?php echo $category_slno ?>">
